...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/framel-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/framel-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add framel libframel python-framel
# for installing globally
pixi global install framel libframel python-framel
```
...
It is possible to list all of the versions of `framel` available on your platform:
...
```
pixi search framel --channel conda-forge
```
